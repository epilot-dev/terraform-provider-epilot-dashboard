...
func (s *Dashboards) CreateDashboard(ctx context.Context, request *shared.DashboardInput, opts ...operations.Option) (*operations.CreateDashboardResponse, error) {
...
func (s *Dashboards) ListDashboards(ctx context.Context, request operations.ListDashboardsRequest, opts ...operations.Option) (*operations.ListDashboardsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Dashboards) PatchDashboard(ctx context.Context, request operations.PatchDashboardRequest, opts ...operations.Option) (*operations.PatchDashboardResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "DashboardPatch", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.PatchDashboardResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
