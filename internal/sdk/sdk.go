...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.918.3
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.16.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.16.0 2.918.3 0.0.1 github.com/epilot-dev/terraform-provider-epilot-dashboard/internal/sdk",
	...
	sdk.Insights = newInsights(sdk, sdk.sdkConfiguration, sdk.hooks)
